...
export const useFormSubmit = <T extends z.ZodSchema<any>>(
  ...
  const [redirect, setRedirect] = useState<string | null>(null); // Use null to signify no redirect
      ...
      startTransition(() => {        
        action(data, {
          ...
          .catch((error) => {
            ...
            console.error('Submission Error:', error.stack);
  ...
  return { form, message, redirect, isPending, onSubmit : form.handleSubmit(onSubmit(onSubmitAction)), captchaState };
};
